...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("create table " + MyProviderMetaData.USER_TABLE_NAME
				...
				+ " varchar(50));");
		db.execSQL("create table " + MessageEntity.MessageTableMetaData.TABLE_NAME
				+"(" + MessageEntity.MessageTableMetaData._ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ MessageEntity.MessageTableMetaData.DATE
				+ " varchar(20),"
				+ MessageEntity.MessageTableMetaData.TTMTYPE
				+ " INTEGER,"
				+ MessageEntity.MessageTableMetaData.TTMCONTENT
				+ " varchar(50),"
				+ MessageEntity.MessageTableMetaData.VOICEFILE
				+ " varchar(30),"
				+ MessageEntity.MessageTableMetaData.IMAGEFILE
				+ " varchar(30),"
				+ MessageEntity.MessageTableMetaData.type
				+ " Integer,"
				+ MessageEntity.MessageTableMetaData.REMOTEDEVICENO
				+ " varchar(20));"
				);
