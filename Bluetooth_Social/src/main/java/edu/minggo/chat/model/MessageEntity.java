...
public class MessageEntity {
	...
	public static final class MessageTableMetaData implements BaseColumns{
		...
		public static final String TTMTYPE = "TtmType";             //消息类型（1.字符串 2.图片 3.声音 4.位置）
		public static final String REMOTEDEVICENO = "remoteDeviceNo";   //远程蓝牙序列号
		public static final String MYDEVICENO = "myDeviceNo";       //我的蓝牙序列号
		public static final String TTMCONTENT = "TtmContent";       //消息内容
		public static final String IMAGEFILE = "ImageFile";        //图片文件路径
		public static final String VOICEFILE = "VoiceFile";        //声音文件路径
